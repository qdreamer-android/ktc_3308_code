...
public class FieldVerifyUtil {
    ...
    /**
     * 验证注册密码，长度为 6-20 的字母和数字的组合
     */
    private static final String REGEX_REGISTER_PASSWORD = "^(?![0-9]+$)(?![a-zA-Z]+$)[0-9A-Za-z]{6,20}$";
     ...
     * 验证注册密码是否是数字和英文字母的组合
     */
    public static boolean registerPwdIsOk(final String password) {
        return isMatch(REGEX_REGISTER_PASSWORD, password);
    }
